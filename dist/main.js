...
function appendTodoList(parent){
    ...
    selectedProject.tasks.forEach(list => {
        ...
        var result = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(newYear, newMonth-1, newDay), 'PP')
